...
LIBDIR_DEBUG = $(LIBDIR)
LIB_DEBUG = $(LIB)-l../../../../../../usr/lib/x86_64-linux-gnu/libGL.so -l../../../../../../usr/lib/x86_64-linux-gnu/libGLU.so -l../../../../../../usr/lib/x86_64-linux-gnu/libglut.so lib/libfreenect.a -llib/libfreenect.so -l../../../../../../usr/lib/x86_64-linux-gnu/libusb-1.0.so
LDFLAGS_DEBUG = $(LDFLAGS) -pthread -lusb-1.0
OBJDIR_DEBUG = obj/Debug
DEP_DEBUG = 
OUT_DEBUG = bin/Debug/balayeuse

INC_RELEASE = $(INC) -I../../../../../../usr/include/libusb-1.0
CFLAGS_RELEASE = $(CFLAGS) -O2
RESINC_RELEASE = $(RESINC)
RCFLAGS_RELEASE = $(RCFLAGS)
LIBDIR_RELEASE = $(LIBDIR)
LIB_RELEASE = $(LIB)-l../../../../../../usr/lib/x86_64-linux-gnu/libGL.so -l../../../../../../usr/lib/x86_64-linux-gnu/libGLU.so -l../../../../../../usr/lib/x86_64-linux-gnu/libglut.so lib/libfreenect.a -llib/libfreenect.so -l../../../../../../usr/lib/x86_64-linux-gnu/libusb-1.0.so
LDFLAGS_RELEASE = $(LDFLAGS) -s -pthread -lusb-1.0
OBJDIR_RELEASE = obj/Release
DEP_RELEASE = 
OUT_RELEASE = bin/Release/balayeuse

OBJ_DEBUG = $(OBJDIR_DEBUG)/CloudPointContainer.o $(OBJDIR_DEBUG)/Mutex.o $(OBJDIR_DEBUG)/MyFreenectDevice.o $(OBJDIR_DEBUG)/SceneCamera.o $(OBJDIR_DEBUG)/cpp_pc_view.o

OBJ_RELEASE = $(OBJDIR_RELEASE)/CloudPointContainer.o $(OBJDIR_RELEASE)/Mutex.o $(OBJDIR_RELEASE)/MyFreenectDevice.o $(OBJDIR_RELEASE)/SceneCamera.o $(OBJDIR_RELEASE)/cpp_pc_view.o
